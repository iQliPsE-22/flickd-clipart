...
export default function ImageDetail() {
  ...
  const imageDate = new Date(selectedImage.timestamp).toLocaleDateString(
    "en-US",
    {
      month: "short",
      day: "numeric",
  ...
  const handleExportSVG = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Export SVG Failed",
        e?.message || "An error occurred during vector export.",
      );
    } finally {
      setIsDownloading(false);
    }
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.actionSection}>
          ...
          <Text style={styles.promptText}>
            ...
            <Text style={styles.promptEmphasis}>"{imageStyle}"</Text>
            {" using AI"}
          </Text>
          ...
          <View style={{ gap: 12, marginBottom: 20 }}>
            ...
            >
              ...
              />
              <Text style={styles.secondaryExportText}>
          ...
          >
            ...
            <View style={styles.createMoreTextContainer}>
              ...
              <Text style={styles.createMoreSubtitle}>
